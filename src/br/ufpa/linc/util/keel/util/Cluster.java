package br.ufpa.linc.util.keel.util;
...
public class Cluster {
    ...
    /**
     * <p>
     * Returns the number of times a determined attribute value appears in the
     * instances of this cluster
     * </p>
     *
     * @param at the attribute value
     * @param numat the attribute index
     * @return the observed times the value has appeared in attribute numat in
    ...
    public int getObserved(String at, int numat) {
        ...
        for (int i = 0; i < C.size(); i++) {
            inst = (String) C.elementAt(i);
            String attributeValues[] = inst.split(",");
            if (attributeValues[numat].trim().compareTo(at) == 0) {
                obs++;
            }
        }
        return obs;
